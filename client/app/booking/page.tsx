...
function BookingPageContent() {
  ...
  const [preSelectedRoomId, setPreSelectedRoomId] = useState<string | null>(
    null
  );
      ...
      if (response.data.success) {
        ...
        if (preSelectedRoomId) {
          const preSelected = roomsData.find(
            (room: any) => room.id === parseInt(preSelectedRoomId)
          );
          if (preSelected) {
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <RoomLayout
                          mode={
                            (selectedRoom.capacity || 0) >= 10 ? "book" : "view"
                          }
                      ...
                      {(selectedRoom.capacity || 0) < 10 && (
                        <div className="mt-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 border border-blue-200 dark:border-blue-800">
                          <p className="text-blue-800 dark:text-blue-200 text-sm">
                            <strong>Small Room Booking:</strong> This room will
                            be reserved entirely for your use during the
...
export default function BookingPage() {
  return (
    <Suspense
      fallback={<PageLoadingFallback message="Loading booking page..." />}
    >
      <BookingPageContent />
    </Suspense>
  );
